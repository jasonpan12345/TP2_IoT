...
class DeviceMethod {
    ...
    invokeOn(deviceId, done) {
        return (0, azure_iot_common_2.tripleValueCallbackToPromise)((_callback) => {
            ...
            const path = '/twins/' + encodeURIComponent(deviceId) + '/methods' + azure_iot_common_1.endpoint.versionQueryString();
            const headers = {
    ...
    invokeOnModule(deviceId, moduleId, done) {
        return (0, azure_iot_common_2.tripleValueCallbackToPromise)((_callback) => {
            ...
            const path = '/twins/' + encodeURIComponent(deviceId) + '/modules/' + encodeURIComponent(moduleId) + '/methods' + azure_iot_common_1.endpoint.versionQueryString();
            const headers = {
                'Content-Type': 'application/json; charset=utf-8'
            };
