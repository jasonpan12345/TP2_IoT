...
const ArgumentError = azure_iot_common_1.errors.ArgumentError;
/**
...
class Registry {
    ...
    create(deviceInfo, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            <deviceInfo>
            ```]*/
            const path = azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceInfo.deviceId)) + azure_iot_common_1.endpoint.versionQueryString();
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
    ...
    get(deviceId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            Request-Id: <guid>
            ```]*/
            const path = azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceId)) + azure_iot_common_1.endpoint.versionQueryString();
    ...
    list(done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            /*Codes_SRS_NODE_IOTHUB_REGISTRY_16_029: [The `list` method shall construct an HTTP request using information supplied by the caller, as follows:
               ...
               Request-Id: <guid>
               ```]*/
            const path = azure_iot_common_1.endpoint.devicePath('') + azure_iot_common_1.endpoint.versionQueryString();
    ...
    importDevicesFromBlob(inputBlobContainerUri, outputBlobContainerUri, done) {
        return (0, azure_iot_common_2.callbackToPromise)((_callback) => {
            ...
            ```]*/
            const path = '/jobs/create' + azure_iot_common_1.endpoint.versionQueryString();
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
            const importRequest = {
    ...
    listJobs(done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            /*Codes_SRS_NODE_IOTHUB_REGISTRY_16_037: [The `listJobs` method shall construct an HTTP request using information supplied by the caller, as follows:
                ...
                Request-Id: <guid>
                ```]*/
            const path = '/jobs' + azure_iot_common_1.endpoint.versionQueryString();
    ...
    getJob(jobId, done) {
        return (0, azure_iot_common_2.callbackToPromise)((_callback) => {
            ...
            Request-Id: <guid>
            ```]*/
            const path = '/jobs/' + jobId + azure_iot_common_1.endpoint.versionQueryString();
            this._restApiClient.executeApiCall('GET', path, null, null, _callback);
        }, done);
    }
    ...
    getTwin(deviceId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            Request-Id: <guid>
            ```]*/
            const path = '/twins/' + encodeURIComponent(deviceId) + azure_iot_common_1.endpoint.versionQueryString();
    ...
    getModuleTwin(deviceId, moduleId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `/twins/${encodeURIComponent(deviceId)}/modules/${encodeURIComponent(moduleId)}${azure_iot_common_1.endpoint.versionQueryString()}`;
            this._restApiClient.executeApiCall('GET', path, null, null, (err, newTwin, response) => {
                if (err) {
                    _callback(err);
                }
    ...
    getRegistryStatistics(done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            const path = '/statistics/devices' + azure_iot_common_1.endpoint.versionQueryString();
    ...
    addConfiguration(configuration, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `/configurations/${encodeURIComponent(configuration.id)}${azure_iot_common_1.endpoint.versionQueryString()}`;
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
    ...
    getConfiguration(configurationId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `/configurations/${encodeURIComponent(configurationId)}${azure_iot_common_1.endpoint.versionQueryString()}`;
            this._restApiClient.executeApiCall('GET', path, null, null, _callback);
        }, done);
    }
    getConfigurations(done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `/configurations${azure_iot_common_1.endpoint.versionQueryString()}`;
            this._restApiClient.executeApiCall('GET', path, null, null, _callback);
        }, done);
    }
    ...
    applyConfigurationContentOnDevice(deviceId, content, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `${azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceId))}/applyConfigurationContent${azure_iot_common_1.endpoint.versionQueryString()}`;
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
    ...
    addModule(module, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `${azure_iot_common_1.endpoint.modulePath(encodeURIComponent(preparedModule.deviceId), encodeURIComponent(preparedModule.moduleId))}${azure_iot_common_1.endpoint.versionQueryString()}`;
            const httpHeaders = {
                'Content-Type': 'application/json; charset=utf-8'
            };
    ...
    getModulesOnDevice(deviceId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `${azure_iot_common_1.endpoint.devicePath(encodeURIComponent(deviceId))}/modules${azure_iot_common_1.endpoint.versionQueryString()}`;
            this._restApiClient.executeApiCall('GET', path, null, null, _callback);
        }, done);
    }
    getModule(deviceId, moduleId, done) {
        return (0, azure_iot_common_2.httpCallbackToPromise)((_callback) => {
            ...
            const path = `${azure_iot_common_1.endpoint.modulePath(encodeURIComponent(deviceId), encodeURIComponent(moduleId))}${azure_iot_common_1.endpoint.versionQueryString()}`;
            this._restApiClient.executeApiCall('GET', path, null, null, _callback);
        }, done);
    }
    ...
    _bulkOperation(devices, done) {
        ...
        const path = '/devices' + azure_iot_common_1.endpoint.versionQueryString();
        const httpHeaders = {
            'Content-Type': 'application/json; charset=utf-8'
        };
    ...
    _executeQueryFunc(sqlQuery, pageSize) {
        return (continuationToken, done) => {
            ...
            ```]*/
            const path = '/devices/query' + azure_iot_common_1.endpoint.versionQueryString();
            const headers = {
                'Content-Type': 'application/json; charset=utf-8'
            };
