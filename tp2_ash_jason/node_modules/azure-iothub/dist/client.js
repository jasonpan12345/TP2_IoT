...
class Client extends events_1.EventEmitter {
    ...
    open(done) {
        ...
        }, (r, m) => { return (0, interfaces_1.createResultWithIncomingMessage)(r, m); }, done);
    }
    close(done) {
        return (0, azure_iot_common_3.tripleValueCallbackToPromise)((_callback) => {
    ...
    invokeDeviceMethod(deviceId, moduleIdOrMethodParams, methodParamsOrDone, done) {
        ...
        if (moduleId) {
            ...
            }, (r, m) => { return (0, interfaces_1.createResultWithIncomingMessage)(r, m); }, callback);
        }
        else {
            return (0, azure_iot_common_3.tripleValueCallbackToPromise)((_callback) => {
    ...
    _disconnectHandler(reason) {
        ...
        let evt = new azure_iot_common_1.results.Disconnected();
        evt.reason = reason;
