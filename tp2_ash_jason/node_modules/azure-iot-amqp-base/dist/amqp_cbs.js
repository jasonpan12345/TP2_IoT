...
class ClaimsBasedSecurityAgent extends events_1.EventEmitter {
            ...
            states: {
                ...
                attached: {
                    ...
                    putToken: (audience, token, putTokenCallback) => {
                        ...
                        let amqpMessage = new amqp_message_1.AmqpMessage();
    ...
    _removeExpiredPutTokens() {
        ...
        expiredPutTokens.forEach((currentExpiredPut) => {
            ...
            currentExpiredPut.putTokenCallback(new azure_iot_common_1.errors.TimeoutError('Put Token operation had no response within ' + this._putToken.numberOfSecondsToTimeout));
        });
        //
