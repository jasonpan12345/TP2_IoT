        ...
        this._fsm = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    _onEnter: (disconnectCallback, err, _result) => {
                        if (disconnectCallback) {
                            if (err) {
                                ...
                                this._safeCallback(disconnectCallback, null, new azure_iot_common_1.results.Disconnected());
                            }
                        }
                        else if (this._disconnectHandler) {
                            debug('calling upper layer disconnect handler');
                            debugErrors('error passed to disconnect handler is: ' + (0, amqp_common_errors_1.getErrorName)(err || new azure_iot_common_1.errors.NotConnectedError('rhea: connection disconnected')));
                            this._disconnectHandler(err || new azure_iot_common_1.errors.NotConnectedError('rhea: connection disconnected'));
                        }
                    },
                    amqpError: (err) => {
                    ...
                    attachSenderLink: (_endpoint, _linkOptions, callback) => callback(new azure_iot_common_1.errors.NotConnectedError()),
                    attachReceiverLink: (_endpoint, _linkOptions, callback) => callback(new azure_iot_common_1.errors.NotConnectedError()),
                    ...
                    initializeCBS: (callback) => callback(new azure_iot_common_1.errors.NotConnectedError()),
                    putToken: (_audience, _token, callback) => callback(new azure_iot_common_1.errors.NotConnectedError()),
                },
                connecting: {
                    ...
                    disconnected: (_context) => {
                        ...
                        this._connectionCallback = undefined;
                        manageConnectionHandlers('removeListener');
                        this._fsm.transition('disconnected', callback, new azure_iot_common_1.errors.NotConnectedError('rhea: connection disconnected'));
                    },
                ...
                connected: {
                    _onEnter: (connectCallback, result) => {
                        ...
                        this._safeCallback(connectCallback, null, new azure_iot_common_1.results.Connected(result));
                    },
                    session_error: (context) => {
                        this._indicatedSessionError = context.session.error;
                    },
                    ...
                    disconnected: (_context) => {
                        ...
                        this._fsm.transition('disconnecting', null, new azure_iot_common_1.errors.NotConnectedError('rhea: connection disconnected'));
                    },
                    amqpError: (err) => {
                        this._fsm.transition('disconnecting', null, err);
                    },
                    connect: (_policyOverride, callback) => callback(null, new azure_iot_common_1.results.Connected()),
                    ...
                    send: (message, endpoint, to, done) => {
                        ...
                        let amqpMessage = amqp_message_1.AmqpMessage.fromMessage(message);
                        if (to !== undefined) {
                            amqpMessage.to = to;
                        }
