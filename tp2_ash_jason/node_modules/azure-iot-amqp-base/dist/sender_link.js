            ...
            states: {
                detached: {
                    _onEnter: (callback, err) => {
                        let messageCallbackError = err || new azure_iot_common_1.errors.ServiceUnavailableError('Sender Link Detached');
                ...
                attached: {
                    ...
                    senderCloseEvent: (context) => {
                        ...
                        if (!error) {
                            ...
                            if ((senderState === null || senderState === void 0 ? void 0 : senderState.local_open) && !(senderState === null || senderState === void 0 ? void 0 : senderState.remote_open)) {
                                error = new azure_iot_common_1.errors.NotConnectedError('Remote link closed');
                            }
                        }
                        this._senderCloseOccurred = true;
                        if (error) {
                    ...
                    send: () => {
                        while ((this._unsentMessageQueue.length > 0) && this._rheaSender.sendable()) {
                            ...
                            let sendDeliveryObject = this._rheaSender.send(opToSend.message);
